...
ServerCommand _$ServerCommandFromJson(Map json) {
  return ServerCommand(
      _$enumDecodeNullable(_$ServerCommandTypeEnumMap, json['type']));
}

Map<String, dynamic> _$ServerCommandToJson(ServerCommand instance) =>
    <String, dynamic>{'type': _$ServerCommandTypeEnumMap[instance.type]};
